...
namespace HarakaMQ.MessageBroker
{
    internal class Program
    {
        ...
        private static void Initialize()
        {
            ...
            _udpCommunication.ClockSyncMessage += ClockSyncMessageReceived;
        ...
        private static void ClockSyncMessageReceived(object sender, MessageReceivedEventArgs e)
        {
            _gossip.ClockSyncMessageReceived(e);
        }
    }
}